...
int main() {
  // เขียนโปรแกรมเพิ่ม เพื่อหาขนาดตัวแปรที่กำหนด
   ...
   cout << "Min of short unsigned short int : " << numeric_limits<unsigned short int>::min() << endl;
   cout << "Max of short unsigned short int : " << numeric_limits<unsigned short int>::max() << endl;
